module.exports = {
    ...
    keywords: [
        ...
        'ley 21.015',
        'casos de éxito en la contratación de personas con discapacidad',
        'inclusión laboral',
        'senadis',
        'fundación tacal',
        'accesibilidad',
    ...
    rssFeeds: [
        ...
        { url: 'https://news.google.com/rss/search?q="ley+21015"+OR+"ley+21.015"&hl=es-CL&gl=CL&ceid=CL:es-419', sourceName: 'Google News - Ley 21.015' },
